            ...
            <div class="col-md-12">                 
               ...
               <div class="form-group">
                  <div class="col-md-4">          
                     ...
                     @endif      
                     {{ Form::text('code', old('code'), array('class'=>'form-control', 'id' => 'selectCode', 'size' => 40)) }}                     
                     </div>
                  </div>
               </div>
               ...
               <div class="form-group">
                  <div class="col-md-4">          
                     ...
                     @endif      
                     {{ Form::text('email', old('email'), array('class'=>'form-control', 'id' => 'selectEmail', 'size' => 40)) }}                     
                     </div>
                  </div>
               </div>
               ...
               <div class="form-group">
                  <div class="col-md-4">          
                     ...
                     @endif      
                     {{ Form::select('state_id', $states, old('state_id'), array('class' => 'form-control', 'id' => 'selectState')) }}                    
                     </div>
                  </div>
               </div>
               ...
               <div class="form-group">
                  <div class="col-md-4">          
                     ...
                     @endif      
                     {{ Form::select('mukim_id', $mukims, old('mukim_id'), array('class' => 'form-control', 'id' => 'selectMukim')) }}                
                     </div>
                  </div>
               </div>
               ...
               <div class="form-group">
                  <div class="col-md-4">          
                     ...
                     @endif      
                     {{ Form::select('district_id', $districts, old('district_id'), array('class' => 'form-control', 'id' => 'selectDistrict')) }}                   
                     </div>
                  </div>
               </div>
