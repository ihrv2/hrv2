            ...
            <div class="col-md-12">                 
				...
				<div class="form-group">
					<div class="col-md-4">          
						...
						@endif      
						{{ Form::text('year_from', $detail->year_from, array('class'=>'form-control', 'id' => 'selectStart', 'size' => 40)) }}                     
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-md-4">          
						...
						@endif       
						{{ Form::text('year_to', $detail->year_to, array('class'=>'form-control', 'id' => 'selectEnd', 'size' => 40)) }}                    
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-md-4">          
						...
						@endif                    
						{{ Form::text('name_education', $detail->name_education, array('class'=>'form-control', 'id' => 'selectInstitution', 'size' => 40)) }}       
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-md-4">          
						...
						@endif              
						{{ Form::text('result', $detail->result, array('class'=>'form-control', 'id' => 'selectResult', 'size' => 40)) }}             
						</div>
					</div>
				</div>
