            ...
            <div class="col-md-12">                 
				...
				<div class="form-group">
					<div class="col-md-4">          
						...
						@endif      
						{{ Form::select('status_contract_id', $status_contracts, $detail->status_contract_id, array('class' => 'form-control', 'id' => 'selectStatusContract')) }}                 
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-md-3">  
						...
						<div class="input-group date" id="pick_start_date">
							{{ Form::text('date_from', date('d/m/Y', strtotime($detail->date_from)), array('class' => 'form-control', 'data-date-format' => 'DD/MM/YYYY', 'id' => 'selectStartDate')) }}
				...
				<div class="form-group">
					<div class="col-md-3">  
						...
						<div class="input-group date" id="pick_end_date">
							{{ Form::text('date_to', date('d/m/Y', strtotime($detail->date_to)), array('class' => 'form-control', 'data-date-format' => 'DD/MM/YYYY', 'id' => 'selectEndDate')) }}
							<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
						</div>						
					</div>
				</div>
