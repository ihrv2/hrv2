            ...
            <div class="col-md-12">                 
               ...
               <div class="form-group">
                  <div class="col-md-4">          
                     ...
                     @endif      
                     {{ Form::text('relation', old('relation'), array('class'=>'form-control', 'id' => 'selectRelationship', 'size' => 40)) }}                     
                     </div>
                  </div>
               </div>
               ...
               <div class="form-group">
                  <div class="col-md-4">          
                     ...
                     @endif      
                     {{ Form::text('period_known', old('period_known'), array('class'=>'form-control', 'id' => 'selectPeriod', 'size' => 40)) }}                     
                     </div>
                  </div>
               </div>
